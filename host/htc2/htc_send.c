...
extern int HTC_credit_report_has_arrived;
extern wait_queue_head_t HTC_credit_report_queue;
...
void HTCProcessCreditRpt(HTC_TARGET *target, HTC_CREDIT_REPORT *pRpt, int NumEntries, HTC_ENDPOINT_ID FromEndpoint)
{
    ...
    HTC_credit_report_has_arrived = 1;
    wake_up(&HTC_credit_report_queue);
