...
#define HI_OPTION_TIMER_WAR          0x0001 /* Enable timer workaround */
#define HI_OPTION_BMI_CRED_LIMIT     0x0002 /* Limit BMI command credits */
#define HI_OPTION_RELAY_DOT11_HDR    0x0004 /* Relay Dot11 hdr to/from host */
#define HI_OPTION_FW_MODE_LSB        0x0008 /* low bit of MODE (see below) */
#define HI_OPTION_FW_MODE_MSB        0x0010 /* high bit of MODE (see below) */
#define HI_OPTION_ENABLE_PROFILE     0x0020 /* Enable CPU profiling */
#define HI_OPTION_DISABLE_DBGLOG     0x0040 /* Disable debug logging */
#define HI_OPTION_SKIP_ERA_TRACKING  0x0080 /* Skip Era Tracking */
#define HI_OPTION_PAPRD_DISABLE      0x0100 /* Disable PAPRD (debug) */
#define HI_OPTION_SKIP_REG_SCAN      0x0200 /* Skip regulatory scan */
#define HI_OPTION_INIT_REG_SCAN      0x0400 /* Do regulatory scan during init before
