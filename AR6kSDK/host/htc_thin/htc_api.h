...
typedef void   (*HTC_EP_SEND_PKT_COMP_MULTIPLE)(void *,adf_nbuf_queue_t  ,HTC_ENDPOINT_ID);
 ...
 * transfer the items of the queue into the caller's private queue using:
 *   HTC_PACKET_ENQUEUE() */
typedef void   (*HTC_EP_RECV_PKT_MULTIPLE)(void *, adf_nbuf_queue_t, HTC_ENDPOINT_ID);
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  @desc:          Send a Netbuf to HTC Layer for Transmission to Target
...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
A_STATUS    HTCSendPkt(HTC_HANDLE HTCHandle,
                       adf_nbuf_t nbuf,
                       HTC_ENDPOINT_ID Ep);
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  @see also: HTCFlushEndpoint
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
A_STATUS    HTCSendPktsMultiple(HTC_HANDLE HTCHandle, adf_nubf_queue_t ,HTC_ENDPOINT_ID Ep);
...
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  @see also:
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
A_STATUS    HTCAddReceivePktMultiple(HTC_HANDLE HTCHandle, adf_nbuf_queue_t * ,HTC_ENDPOINT_ID Ep);
